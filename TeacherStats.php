...
$avg_completion_supervisor = floatval($avg_completion_supervisor);
$avg_completion_committee = floatval($avg_completion_committee);
...
<div class="container-fluid">
  <div class="row flex-nowrap">
    ...
    <div class="col py-3">
      ...
      <div class="container">
        <header class="header">
            <div class="header-title">Στατιστικά Διπλωματικών</div>
        </header>
        <hr class="hr">
        <main>
...
<script>
  ...
  const completionTimeData = {
      ...
      datasets: [{
          ...
          data: [<?= $avg_completion_supervisor ?: 0 ?>, <?= $avg_completion_committee ?: 0 ?>],
  ...
  const gradeData = {
      ...
      datasets: [{
          label: 'Μέσος Βαθμός',
      data: [<?= $avg_supervisor_grade ?>, <?= $avg_committee_grade ?>],
  ...
  const totalThesesData = {
      ...
      datasets: [{
        ...
        data: [<?= $count_supervisor ?>, <?= $count_committee ?>],
          backgroundColor: ['#8fbc8f', '#6a7a8c'],
          borderColor: ['#8fbc8f', '#6a7a8c'],
          borderWidth: 1,
          maxBarThickness: 28
