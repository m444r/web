...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['topic_id'], $_POST['deadline'])) {
        ...
        if ($stmt->execute()) {
            header("Location: TeacherPage/TeacherThesisList.php?update=success");
            exit;
        } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cancel_topic_id'])) {
    ...
    if ($stmt->num_rows === 0) {
        ...
        header("Location: TeacherPage/TeacherThesisList.php?");
    exit;
    } else {
        ...
        header("Location: TeacherPage/TeacherThesisList.php?cancel=success");
        exit;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['topic_id'])) {
    ...
    header("Location: TeacherPage/TeacherThesisList.php?ypoeksetasi");
    exit;
}
